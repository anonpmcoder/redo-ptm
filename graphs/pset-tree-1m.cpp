...
#define DATA_FILE "data/pset-tree-1m-cxptm.txt"
...
#define DATA_FILE "data/pset-tree-1m-cxpuc.txt"
#elif defined USE_REDO
#include "ptms/redo/Redo.hpp"
#define DATA_FILE "data/pset-tree-1m-redo.txt"
#elif defined USE_REDOTIMED
#include "ptms/redotimed/RedoTimed.hpp"
#define DATA_FILE "data/pset-tree-1m-redotimed.txt"
#elif defined USE_REDOOPT
#include "ptms/redoopt/RedoOpt.hpp"
#define DATA_FILE "data/pset-tree-1m-redoopt.txt"
...
int main(void) {
    ...
    vector<int> ratioList = { 1000, 100, 10 };                        // Permil ratio: 50%, 10%, 10%
