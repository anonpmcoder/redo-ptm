...
#define DATA_FILE "data/pset-hash-1m-cxptm.txt"
...
#define DATA_FILE "data/pset-hash-1m-cxpuc.txt"
#elif defined USE_REDO
#include "ptms/redo/Redo.hpp"
#define DATA_FILE "data/pset-hash-1m-redo.txt"
#elif defined USE_REDOTIMED
#include "ptms/redotimed/RedoTimed.hpp"
#define DATA_FILE "data/pset-hash-1m-redotimed.txt"
#elif defined USE_REDOOPT
#include "ptms/redoopt/RedoOpt.hpp"
#define DATA_FILE "data/pset-hash-1m-redoopt.txt"
...
#define DATA_FILE "data/pset-hash-1m-pmdk.txt"
#endif
...
int main(void) {
    ...
    vector<int> threadList = { 1, 2, 4, 8, 16, 24, 32, 40};          // For castor
