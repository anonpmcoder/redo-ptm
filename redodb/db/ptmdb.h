...
#define PTM_LOG            redo::gCX.dbLog
#define PTM_FLUSH          redo::gCX.dbFlush
...
#define PTM_LOG            redotimed::gCX.dbLog
#define PTM_FLUSH          redotimed::gCX.dbFlush
...
#define PTM_LOG            redoopt::gCX.dbLog
#define PTM_FLUSH          redoopt::gCX.dbFlush
